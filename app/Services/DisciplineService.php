...
use App\Models\Discipline as ResourceModel;
 ...
 */
class DisciplineService extends AbstractService
{
    /**
     * Constructor class
     * @access public
     ...
     */
    public function getById(int $levelId): ResourceModel
    {
        return parent::getResource($levelId);
    }
     ...
     * @return bool
     */
    public function delete(int $levelId): bool
    {
        return parent::deleteResource($levelId);
    }
}
